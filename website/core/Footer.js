        ...
        <section className='subfooter'>
          <div className='subfooteritens'>
              <div className = "footerDescription">
                <p>Mantido pela <img src={this.props.config.baseUrl+'img/Portabilis_logo_branco.svg'} /> e Comunidade i-Educar para educação do Brasil <img src={this.props.config.baseUrl +'img/coracao.svg'} /> </p>
              </div>
